 ...
 *     if (file == HFILE_ERROR) {
 *       throw orb::windows_error(GetLastError(),
...
std::system_error windows_error(int error_code, string_view message,
                                const Args&... args) {
  return vwindows_error(error_code, message, orb::make_format_args(args...));
}
...
class buffered_file {
 ...
 public:
  ...
  inline void print(string_view fmt, const T&... args) {
    ...
    detail::is_locking<T...>() ? orb::vprint_buffered(file_, fmt, vargs)
                               : orb::vprint(file_, fmt, vargs);
  }
};
...
// orb::system_error in case of failure. Note that some errors such as
...
class ORBFMT_API ostream {
 ...
 public:
  ...
  template <typename... T> void print(format_string<T...> fmt, T&&... args) {
    vformat_to(appender(buffer_), fmt, orb::make_format_args(args...));
  }
};
 ...
 * **Example**:
 *
 *     auto out = orb::output_file("guide.txt");
